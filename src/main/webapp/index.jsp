    ...
    <section class="services">
      <div class="services-grid">
        <div class="service-card">
          ...
          <a href="feepaymentadd.jsp" class="service-link"
            >Add Payment <i class="fas fa-arrow-right"></i
          ></a>
        </div>
        <div class="service-card">
          ...
          <p>
            Update existing payment records with ease. Modify payment details
            with ease.
          </p>
          <a href="feepaymentupdate.jsp" class="service-link"
        ...
        <div class="service-card">
          ...
          <p>
            Generate comprehensive reports based on status like paid,unpaid or
            overdue payments.
          </p>
          <a href="report_form.jsp" class="service-link"
        ...
        <div class="service-card">
          ...
          <p>
            Monitor all payment transactions in real-time. Search, filter, and
            organize payment data efficiently.
          </p>
          <a href="feepaymentdisplay.jsp" class="service-link"
        ...
        <div class="service-card">
          ...
          <p>
            Clean up your database by removing outdated or incorrect payment
            records with proper authorization.
          </p>
          <a href="feepaymentdelete.jsp" class="service-link"
